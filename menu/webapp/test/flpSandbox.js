					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Menu Aplicación SAPUI5",
									"targetURL": "#esjmenu-display"
								}
							}]
						}]
					}
						...
						"inbounds": {
							"esjmenu-display": {
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=esj.menu",
									"url": sap.ui.require.toUrl("esj/menu")
								}
							}
						}
					}
